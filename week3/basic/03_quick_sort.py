...
def qsort(arr, left: int, right: int):
    pl = left
    pr = right
...
if __name__ == "__main__":
    ...
    print("=== 테스트 케이스 1 ===")
    print(f"정렬 전: {arr1}")
    result1 = qsort_helper(arr1.copy())
    ...
    print("=== 테스트 케이스 2 ===")
    print(f"정렬 전: {arr2}")
    result2 = qsort_helper(arr2.copy())
    ...
    print(f"정렬 전: {arr3}")
    result3 = qsort_helper(arr3.copy())
    ...
    print(f"정렬 전: {arr4}")
    result4 = qsort_helper(arr4.copy())
